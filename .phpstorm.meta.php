    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'Flugg\Responder\Contracts\ErrorFactory' => \Flugg\Responder\ErrorFactory::class,
            'Flugg\Responder\Contracts\ErrorMessageResolver' => \Flugg\Responder\ErrorMessageResolver::class,
            'Flugg\Responder\Contracts\ErrorSerializer' => \Flugg\Responder\Serializers\ErrorSerializer::class,
            'Flugg\Responder\Contracts\Pagination\PaginatorFactory' => \Flugg\Responder\Pagination\PaginatorFactory::class,
            'Flugg\Responder\Contracts\Resources\ResourceFactory' => \Flugg\Responder\Resources\ResourceFactory::class,
            'Flugg\Responder\Contracts\Resources\ResourceKeyResolver' => \Flugg\Responder\Resources\ResourceKeyResolver::class,
            'Flugg\Responder\Contracts\Responder' => \Flugg\Responder\Responder::class,
            'Flugg\Responder\Contracts\ResponseFactory' => \Flugg\Responder\Http\Responses\Decorators\SuccessFlagDecorator::class,
            'Flugg\Responder\Contracts\TransformFactory' => \Flugg\Responder\FractalTransformFactory::class,
            'Flugg\Responder\Contracts\Transformers\TransformerResolver' => \Flugg\Responder\Transformers\TransformerResolver::class,
            'Flugg\Responder\Http\Responses\ErrorResponseBuilder' => \Flugg\Responder\Http\Responses\ErrorResponseBuilder::class,
            'Flugg\Responder\TransformBuilder' => \Flugg\Responder\TransformBuilder::class,
            ...
            'League\Fractal\Serializer\SerializerAbstract' => \Flugg\Responder\Serializers\SuccessSerializer::class,
